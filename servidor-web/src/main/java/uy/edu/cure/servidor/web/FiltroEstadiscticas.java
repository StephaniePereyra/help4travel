 ...
 * @author juan
 */
@WebFilter(filterName = "FiltroEstadiscticas", urlPatterns = {"/*"})
public class FiltroEstadiscticas implements Filter {
    ...
    public FiltroEstadiscticas() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FiltroEstadiscticas:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FiltroEstadiscticas:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("FiltroEstadiscticas:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FiltroEstadiscticas()");
        }
        StringBuffer sb = new StringBuffer("FiltroEstadiscticas(");
